...
<head>
	...
	<!-- Favicon and Feed -->
	<link rel="shortcut icon" type="image/x-icon" href="<?php echo get_template_directory_uri(); ?>/icons/code2040_orig.ico">
	<link rel="alternate" type="application/rss+xml" title="<?php bloginfo('name'); ?> Feed" href="<?php echo home_url(); ?>/feed/">

	<!--  iPhone Web App Home Screen Icon -->
	<link rel="apple-touch-icon" sizes="72x72" href="<?php echo get_template_directory_uri(); ?>/icons/code2040_orig.ico" />
	<link rel="apple-touch-icon" sizes="114x114" href="<?php echo get_template_directory_uri(); ?>/icons/code2040_orig.ico" />
	<link rel="apple-touch-icon" href="<?php echo get_template_directory_uri(); ?>/icons/code2040_orig.ico" />
...
js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=254678607908980";
...
<script type="text/javascript">
  //Google Analytics
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-34560737-1']);
